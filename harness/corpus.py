...
def main():
    ...
    corpus = [
        ...
        ("copper bars (bouncing)",
         ["python3", P("anim_check.py"), *hb, "--asm", E("copper-bounce.s"), "--mode", "copper"]),
        ("colour-cycle (per-column)",
         ["python3", P("anim_check.py"), *hb, "--asm", E("cycle-column.s"), "--mode", "cycle"]),
